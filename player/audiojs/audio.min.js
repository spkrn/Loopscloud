(function (h, o, g) {
   ...
   g[h] = {
      ...
      settings: {
         ...
         loop: false,
         preload: true,
         imageLocation: p + "player-graphics2.svg",
         ...
         createPlayer: {
            markup: '          <div class="play-pause" onclick="playTape();">             <p class="play block"></p>             <p class="pause"></p>             <p class="loading"></p>             <p class="error"></p>           </div>           <div class="scrubber">             <div class="progress"></div>             <div class="loaded"></div>           </div>           <div class="time">             <em class="played">00:00</em><strong class="duration">00:00</strong>           </div>           <div class="error-message"></div>',
         ...
         css: '        .audiojs audio { position: absolute; left: -1px; }         .audiojs { width: 248px; height: 36px; overflow: hidde;}       .audiojs .play-pause { width: 12px; height: 21px; margin-top: 13px; margin-left:0px; float: left; overflow: hidden; position:absolute}         .audiojs p { display: none; width: 25px; height: 40px; margin: 0px; cursor: pointer; }       .audiojs .scrubber:hover { height:5px; -webkit-transition-property: height; -webkit-transition-duration: 350ms;}      .audiojs .scrubber { position: absolute; float: left; width: 248px; background: #777777; height: 2px; margin-top: 8px; border-left: 0px; border-bottom: 0px; overflow: hidden; cursor: pointer; -webkit-transition-property: height; -webkit-transition-duration: 350ms;}          .audiojs .progress { position: absolute; top: 0px; left: 0px; height: 5px; width: 0px; border-radius: 0px; background: #bbb; z-index: 1;           background-image: -moz-linear-gradient(center top, #ccc 0%, #ddd 50%, #ccc 51%, #ccc 100%); }         .audiojs .loaded { position: absolute; top: 0px; left: 0px; height: 5px; width: 0px; background: #CBDBE0;          background-image: -moz-linear-gradient(center top, #222 0%, #333 50%, #222 51%, #222 100%); }         .audiojs .time { float: right; height: 36px;margin: -11px 0px 0px 0px; padding: 0px 0px 0px 0px; color: #ddd; font-size: 11px;}         .audiojs .time .duration { display:none;}		.audiojs .time em { padding: 0px 1px 0px 0px; color: #aaa; font-style: normal; font-size:12px; }         .audiojs .time strong { padding: 0px 0px 0px 2px; font-weight: normal; }         .audiojs .error-message { float: left; display: none; margin: 0px 10px; height: 36px; width: 400px; overflow: hidden; line-height: 36px; white-space: nowrap; color: #fff;           text-overflow: ellipsis; -o-text-overflow: ellipsis; -icab-text-overflow: ellipsis; -khtml-text-overflow: ellipsis; -moz-text-overflow: ellipsis; -webkit-text-overflow: ellipsis; }         .audiojs .error-message a { color: #eee; text-decoration: none; padding-bottom: 1px; border-bottom: 1px solid #999; white-space: wrap; }                 .audiojs .play { background: url("$1") 0px -1px no-repeat; }         .audiojs .loading { background: url("$1") -2px -31px no-repeat; }         .audiojs .error { background: url("$1") -2px -61px no-repeat; }         .audiojs .pause { background: url("$1") 0px -91px no-repeat; }                 .playing .play, .playing .loading, .playing .error { display: none; }         .playing .pause { display: block; }                 .loading .play, .loading .pause, .loading .error { display: none; }         .loading .loading { display: block; }                 .error .time, .error .play, .error .pause, .error .scrubber, .error .loading { display: none; }         .error .error { display: block; }         .error .play-pause p { cursor: auto; }         .error .error-message { display: block; }',
         trackEnded: function () {},
         flashError: function () {
